...
public class practical extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            setContentView(R.layout.practical_l);
        }
    ...
    private class JSONParse extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(practical.this);
            ...
            try {
                ...
                for (int i = 0; i < sem_result.length(); i++) {
                    ...
                    if(theory_practical.equals("P")) {
                        ...
                        if(screenInches<5.5)
                        {
                            ListAdapter adapter = new SimpleAdapter(practical.this, resultlist,
                                    R.layout.layout3,
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_practical, menu);
        return true;
    }
